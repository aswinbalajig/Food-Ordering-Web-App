<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="food_ordering_app.admin.Product" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="txtQuantity" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                             ...
                                             <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" 
                                                 ...
                                                 <ItemTemplate>
                                                     <tr>
                                                         ...
                                                         <td>
                                                             <img alt="" width="40" src="<%# food_ordering_app.Utils.GetImageUrl(Eval("ImageUrl")) %>" />
                                                         </td>
                                                          <td><%#Eval("Price") %></td>
                                                         <td>
