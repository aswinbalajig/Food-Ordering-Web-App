<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="food_ordering_app.admin.OrderStatus" %>
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><%#Eval("Address") %></td> <%--if error check this code--%>
                                                                <td>
