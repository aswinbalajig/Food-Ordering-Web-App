        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    Session["userAddress"] = txtAddress.Text.Trim();
                    lblMsg.Visible = true;
                ...
                catch (SqlException ex)
                {
                    ...
                    {   if (ex.Message.Contains("(" + txtEmail.Text.Trim() + ")"))
                            {
                                lblMsg.Visible = true;
                                lblMsg.Text = "<b>" + txtEmail.Text.Trim() + "</b> email id already exist, try new one..!";
                                lblMsg.CssClass = "alert alert-danger";
                            }
                        
                        else if (ex.Message.Contains("(" + txtUsername.Text.Trim() + ")"))
                        {
                            lblMsg.Visible = true;
