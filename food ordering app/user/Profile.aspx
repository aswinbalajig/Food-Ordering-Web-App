<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="food_ordering_app.user.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src="<%= food_ordering_app.Utils.GetImageUrl(imageurl) %>" id="imgProfile" style="width: 150px; height: 150px;"
                                            class="img-thumbnail" />
