<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="food_ordering_app.user.Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section layout_padding">
        <div class="container">
            ...
            <asp:Label ID="lblHeaderMsg" runat="server" Text="<h1>User Registration</h1>"></asp:Label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form_container">
                    ...
                    <div>
                        ...
                        <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Mobile Number must have 10 digits only" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]{10}$" ControlToValidate="txtMobile"></asp:RegularExpressionValidator>
            ...
            <div class="col-md-6">
                <div class="form_container">
                    ...
                    <div>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Address is required" ControlToValidate="txtAddress" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
